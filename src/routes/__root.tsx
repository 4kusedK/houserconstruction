...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Houser Construction" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Barlow:wght@600;700;800&family=Archivo:wght@700;800;900&family=Inter:wght@400;500;600&display=swap",
      },
    ],
  }),
